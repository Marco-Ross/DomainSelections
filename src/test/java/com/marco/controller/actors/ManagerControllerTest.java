...
public class ManagerControllerTest {
    ...
    private String baseURL = "http://localhost:8080/railway/manager";
    ...
    public void e_delete() {
        ...
        restTemplate.delete(baseURL + "/delete/" + manager.getEmployeeNumber());
    ...
    @Test
    public void b_read() {
        ResponseEntity<Manager> managerResponseEntity = restTemplate.getForEntity(baseURL + "/read/32", Manager.class);
